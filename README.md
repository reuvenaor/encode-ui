...
Component lookup over the [encode-ui registry](https://encode-ui.com) — 399 shadcn
registry items (346 components + 53 OKLCH palettes), served to AI coding agents over MCP. Your agent searches the catalog, reads any
