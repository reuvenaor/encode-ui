...
Component lookup over the [encode-ui registry](https://encode-ui.com) — 414 shadcn
registry items (361 components + 53 OKLCH palettes), served to AI coding agents over MCP. Your agent searches the catalog, reads any
...
the uniqueness math the registry's 53 themes each passed, and hands back paste-ready CSS
variables.
